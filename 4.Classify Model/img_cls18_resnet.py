...
train_data_dir = 'a_data_18/train'
validation_data_dir = 'a_data_18/valid'
...
checkpointer = ModelCheckpoint(filepath='a_resnet_18_best_model_4class.hdf5', verbose=1, save_best_only=True)
...
model.save('a_resnet_18_model_trained_class.hdf5')
